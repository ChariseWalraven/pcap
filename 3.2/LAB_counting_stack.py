# We've showed you recently how to extend Stack possibilities by defining a new class (i.e., a subclass)
# which retains all inherited traits and adds some new ones.

# Your task is to extend the Stack class behavior in such a way so that the class is able to count all the
# elements that are pushed and popped (we assume that counting pops is enough). Use the Stack class we've
