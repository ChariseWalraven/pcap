...
# objects of the class should be "printable", i.e. they should be able to implicitly convert themselves into strings of
# the same form as the constructor arguments;
